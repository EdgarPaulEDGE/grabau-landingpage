...
export default function Header() {
  ...
  return (
    <>
      {/* Abdunklung unter dem offenen Mobile-Menü: trennt Menü und Seite,
          ein Tipp daneben schließt es */}
      <div
        aria-hidden="true"
        onClick={() => setOpen(false)}
        className={cn(
          "fixed inset-0 z-40 bg-night/60 backdrop-blur-[2px] transition-opacity duration-300 lg:hidden",
